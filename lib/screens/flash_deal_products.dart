...
import 'package:afriomarkets_cust_app/helpers/string_helper.dart';
...
class FlashDealProducts extends StatefulWidget {
  FlashDealProducts(
      {Key? key, required this.flash_deal_id, required this.flash_deal_name})
      : super(key: key);
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            ProductMiniResponse productResponse =
                snapshot.data as ProductMiniResponse;
