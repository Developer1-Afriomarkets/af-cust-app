...
import 'package:afriomarkets_cust_app/screens/map_location.dart';
...
class _AddressState extends State<Address> {
  ...
  // placeholder, will define after viewings for add purpose
  ...
  onAddressAdd(context) async {
    ...
    var addressAddResponse = await AddressRepository().getAddressAddResponse(
        address: address,
        country_id: _selected_country!.id ?? 0,
        state_id: _selected_state!.id ?? 0,
        city_id: _selected_city!.id ?? 0,
  ...
  onAddressUpdate(context, index, id) async {
    ...
    var addressUpdateResponse = await AddressRepository()
        .getAddressUpdateResponse(
            id: id,
            address: address,
            country_id: _selected_country_list_for_update[index]!.id ?? 0,
            state_id: _selected_state_list_for_update[index]!.id ?? 0,
            city_id: _selected_city_list_for_update[index]!.id ?? 0,
            postal_code: postal_code,
            phone: phone);
              ...
              SliverList(
                ...
                Padding(
                  ...
                  child: TextButton(
                    style: TextButton.styleFrom(
                      minimumSize:
                          Size(MediaQuery.of(context).size.width - 16, 60),
