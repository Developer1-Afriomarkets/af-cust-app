...
import 'package:afriomarkets_cust_app/screens/flash_deal_products.dart';
import 'package:afriomarkets_cust_app/repositories/flash_deal_repository.dart';
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            //snapshot.hasData
            FlashDealResponse flashDealResponse =
                snapshot.data as FlashDealResponse;
                  ...
                  child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: FadeInImage.assetNetwork(
                            ...
                            image: PathHelper.getImageUrlSafe(flashDealResponse.flash_deals[index].banner),
                            fit: BoxFit.cover,
                          ))),
                ),
                Padding(
