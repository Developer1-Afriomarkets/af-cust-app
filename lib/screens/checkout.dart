...
import 'package:afriomarkets_cust_app/screens/stripe_screen.dart';
import 'package:afriomarkets_cust_app/screens/paypal_screen.dart';
import 'package:afriomarkets_cust_app/screens/razorpay_screen.dart';
import 'package:afriomarkets_cust_app/screens/paystack_screen.dart';
import 'package:afriomarkets_cust_app/screens/iyzico_screen.dart';
import 'package:afriomarkets_cust_app/screens/bkash_screen.dart';
import 'package:afriomarkets_cust_app/screens/nagad_screen.dart';
import 'package:afriomarkets_cust_app/screens/sslcommerz_screen.dart';
import 'package:afriomarkets_cust_app/screens/flutterwave_screen.dart';
...
import 'package:afriomarkets_cust_app/repositories/coupon_repository.dart';
...
import 'package:afriomarkets_cust_app/screens/offline_screen.dart';
import 'package:afriomarkets_cust_app/screens/paytm_screen.dart';
...
class _CheckoutState extends State<Checkout> {
  ...
  fetchSummary() async {
    ...
    if (cartSummaryResponse != null) {
      ...
      _coupon_applied = cartSummaryResponse.coupon_applied ?? false;
      setState(() {});
    }
  }
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          color: MyTheme.accent_color, fontSize: 14, fontWeight: FontWeight.w600),
                                    ),
                                  ),
                                  Padding(
                  ...
                  Container(
                      ...
                      child: Padding(
                          ...
                          fit: BoxFit.fitWidth,
                            ...
                            image: PathHelper.getImageUrlSafe(_paymentTypeList[index].image),
                            fit: BoxFit.fitWidth,
                          ))),
                  Container(
                    width: 150,
