...
class CartSummaryResponse {
  ...
  factory CartSummaryResponse.fromJson(Map<String, dynamic> json) =>
      CartSummaryResponse(
        ...
        grand_total_value: (json["grand_total_value"] is int ||
                json["grand_total_value"] is double)
            ? json["grand_total_value"].toDouble()
            : double.tryParse(json["grand_total_value"].toString()),
