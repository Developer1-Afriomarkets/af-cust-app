...
final List<AChat> chatList = [
  ...
  AChat(
      ...
      is_sender: false),
  AChat(text: "Thanks.", is_sender: true),
  AChat(
      text:
          "Please visit our shop regularly. We are offering the highest quality products all time.",
      is_sender: false),
  AChat(
      text: "I haven't got my order yet. Could you please help.",
      is_sender: true),
